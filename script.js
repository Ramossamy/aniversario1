...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Dino samy";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-11-17T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-01-17T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos: <b>${426}</b> días<br>` + 
      `Nuestro aniversario: <b>${0}d ${5}h ${60}m ${60}s</b>`;
